...
<script lang="ts">
// Copy from node_modules\artplayer\types\artplayer.d.ts
...
export type ArtPlayerOptions = Omit<Option, 'container' | 'customType'>
...
onMounted(() => {
  instance = new ArtPlayer({
    ...props.option,
    container: artRef.value as HTMLElement,
    customType: {
